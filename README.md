...
```bash
python generic_tester.py 01
```

### Example Output

```
Loaded 1 inputs and 2 solutions.

Used Solution on 01/input.txt in 0.00083385s with result: 1938424
Approach: 
    Calculate the sum of absolute differences between two columns of numbers.
    
********************

Used Solution on 01/input.txt in 0.00100960s with result: 22014209
Approach: 
